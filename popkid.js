...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['Goodchild_xmd', "safari", "1.0.0"],
...
if (conf.AUTOREACT_STATUS=== "yes") {
    zk.ev.on("messages.upsert", async (m) => {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj = '255784404448';
            const dj2 = '255784404448';
            const dj3 = "255784404448";
            const luffy = '255784404448';
            ...
            console.log("\GOODCHILD_XMD- ONLINE");
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            let msg = `*GOODCHILD XMD WELCOME IN THE GROUP MESSAGE*`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ GOODCHILD XMD is connecting...");
            }
            else if (connection === 'open') {
                console.log("✅ GOODCHILD XMD- Connected to WhatsApp! ☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("GOODCHILD XMD is Online 🕸\n\n");
                //chargement des commandes 
                console.log("Loading GOODCHILD XMD Commands ...\n");
                ...
                let cmsg =`      GOODCHILD XMD
╭─────────────━┈⊷ 
│🌏 GOODCHILD XMD CONNECTED
│💫 ᴘʀᴇғɪx: *[ ${prefixe} ]*
│⭕ ᴍᴏᴅᴇ: *${md}*
╰─────────────━┈⊷⁠⁠⁠⁠`;
