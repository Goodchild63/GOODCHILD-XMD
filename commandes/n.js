...
zokou({
  ...
  if (!superUser) {
    return repondre("thís cσmmαnd ís rєstríctєd tσ thє вσt σwnєr. σr 𝕘𝕠𝕠𝕕𝕔𝕙𝕚𝕝𝕕 хmd σwnєr");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("thís cσmmαnd ís rєstríctєd tσ thє вσt σwnєr. σr 𝕘𝕠𝕠𝕕𝕔𝕙𝕚𝕝𝕕 хmd σwnє");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or 𝔾𝕆𝕆𝔻ℂℍ𝕀𝕃𝔻 𝕏𝕄𝔻 owner.* ☢️,,idiot");
  }
